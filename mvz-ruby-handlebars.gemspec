...
# -*- encoding: utf-8 -*-
# stub: mvz-ruby-handlebars 0.0.6 ruby lib

Gem::Specification.new do |s|
  s.name = "mvz-ruby-handlebars".freeze
  s.version = "0.0.6"

  s.required_rubygems_version = Gem::Requirement.new(">= 0".freeze) if s.respond_to? :required_rubygems_version=
  s.require_paths = ["lib".freeze]
  s.authors = ["Vincent Pretre".freeze, "Hiptest R&D".freeze, "Matijs van Zuijlen".freeze]
  s.date = "2019-05-13"
  ...
  s.homepage = "https://github.com/mvz/ruby-handlebars".freeze
